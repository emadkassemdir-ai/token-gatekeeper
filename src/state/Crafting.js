...
export const RECIPES = [
  ...
  { id: 'dark_oak_planks', output: 'dark_oak_planks', outputCount: 4, inputs: [{ type: 'dark_oak_log', count: 1 }], requiresTable: false },
  { id: 'mangrove_planks', output: 'mangrove_planks', outputCount: 4, inputs: [{ type: 'mangrove_log', count: 1 }], requiresTable: false },
  { id: 'bamboo_sticks', output: 'stick', outputCount: 1, inputs: [{ type: 'bamboo', count: 2 }], requiresTable: false },
